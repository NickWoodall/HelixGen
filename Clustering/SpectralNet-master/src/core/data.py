...
def embed_data(x, dset):
    ...
    json_path = '/home/nwoodall/Desktop/LabFiles/MachineLearning/Helix_Fit/Fit_Learn/SpectralNet-master/src/pretrain_weights/ae_{}.json'.format(dset)
    weights_path = '/home/nwoodall/Desktop/LabFiles/MachineLearning/Helix_Fit/Fit_Learn/SpectralNet-master/src/pretrain_weights/ae_{}_weights.h5'.format(dset)
